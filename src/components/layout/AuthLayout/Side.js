			...
			>
				...
				<div >
					<div className="mb-6 flex items-center gap-4">
						<Avatar className="border-2 border-white" shape="circle" src="/img/avatars/avatar.jpeg" />
						<div className="text-white">
							<div className="font-semibold text-base">Zhongbo Song</div>
							<span className="opacity-80">Senior Software Engineer</span>
						</div>
					</div>
				</div>
